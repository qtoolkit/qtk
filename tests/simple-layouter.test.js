...
describe('SimpleLayouter', function() {
    ...
    it('test px', (done) => {
		...
		button.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"240px", y:"90px", w:"200px", h:"60px"});
    	win.addChild(button);
    ...
    it('test percent', (done) => {
		var button = qtk.Button.create();
		button.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"10%", y:"20%", w:"200px", h:"60px"});
    	button.layoutParam.maxW = 120;
    	button.layoutParam.maxH = 40;
    	win.addChild(button);
    ...
    it('test minus', (done) => {
		var button = qtk.Button.create();
		button.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"-240px", y:"20%", w:"200px", h:"60px"});
    	button.layoutParam.maxW = 120;
    	button.layoutParam.maxH = 40;
    	win.addChild(button);
    ...
    it('test center/middle', (done) => {
		var button = qtk.Button.create();
		button.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"center", y:"middle", w:"200px", h:"300px"});
    	win.addChild(button);
