...
function onReady(app) {
	...
	switchBox.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"25%", y:"10px", w:"80px", h:"30px"});
	win.addChild(switchBox);

	var switchBox = qtk.Switch.create({value:false});
	switchBox.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"25%", y:"60px", w:"80px", h:"30px"});
	win.addChild(switchBox);
