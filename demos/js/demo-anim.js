...
function onReady(app) {
	...
	button.layoutParam = qtk.SimpleLayouterParam.create({x:"60", y:"30px", w:"200", h:"60px"});
	...
	button.layoutParam = qtk.SimpleLayouterParam.create({x:"-260", y:"30px", w:"200", h:"60px"});
	button.on(Events.CLICK, function(evt) {
	...
	image.layoutParam = qtk.SimpleLayouterParam.create({x:"40%", y:"40%", w:"20%", h:"20%"});
