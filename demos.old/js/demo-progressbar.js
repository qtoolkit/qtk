...
function onReady(app) {
	...
	bar1.value = 0.3;
	bar1.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"25%", y:"10px", w:"50%", h:"30px"});
	bar1.childrenLayouter = qtk.SimpleLayouter.createWithOptions();
	win.addChild(bar1);
	
	var slider1 = qtk.Slider.create();
	slider1.value = 0.3;
	slider1.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"25%", y:"50px", w:"50%", h:"30px"});
	slider1.childrenLayouter = qtk.SimpleLayouter.createWithOptions();
	...
	bar2.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"20px", y:"100px", w:"30px", h:"50%"});
	bar2.childrenLayouter = qtk.SimpleLayouter.createWithOptions();
	win.addChild(bar2);

	var slider2 = qtk.Slider.create();
	slider2.set({value:0.3, barType:qtk.ProgressBarType.VERTICAL});;
	slider2.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"100px", y:"100px", w:"30px", h:"50%"});
	slider2.childrenLayouter = qtk.SimpleLayouter.createWithOptions();
	...
	circle.layoutParam = qtk.SimpleLayouterParam.createWithOptions({x:"center", y:"middle", w:"60px", h:"60px"});
	circle.childrenLayouter = qtk.SimpleLayouter.createWithOptions();
	win.addChild(circle);
