describe('LinearLayouter', function() {
    ...
    it('test Horizonal', (done) => {
		var result = h1.x === 10 && h1.y === 0 && h1.w === 60 && h1.h === 30
			&& h2.x === 80 && h2.y === 15 && h2.w === 60 && h2.h === 30
			&& h3.x === 150 && h3.y === 30 && h3.w === 60 && h3.h === 30
			&& h01.x === 230 && h01.y === 15 && h01.w === 60 && h01.h === 30
			&& h02.x === 310 && h02.y === 15 && h02.w === 60 && h02.h === 30
			&& h03.x === 390 && h03.y === 15 && h03.w === 60 && h03.h === 30
			&& hm1.x === 930
			&& hm2.x === 860
			&& hm3.x === 790
    ...
    it('test Vertical', (done) => {
		var result = v1.x === 0 && v1.y === 10 && v1.w === 60 && v1.h === 30
			&& v2.x === 30 && v2.y === 50 && v2.w === 60 && v2.h === 30
			&& v3.x === 60 && v3.y === 90 && v3.w === 60 && v3.h === 30
			&& v01.x === 30 && v01.y === 130 && v01.w === 60 && v01.h === 30
			&& v02.x === 30 && v02.y === 170 && v02.w === 60 && v02.h === 30
			&& vm1.y === 900 
			&& vm2.y === 860
			&& vm3.y === 820
