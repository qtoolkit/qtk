...
describe('test draw image tile', function() {
    it('test draw image tile default', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_DEFAULT, 0, 0, 200, 200, desc, expect, done);
    });
    ...
    it('test draw image tile auto(large width && small height)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_AUTO, 0, 0, 200, 100, desc, expect, done);
    });
////
    it('test draw image tile 3patch horizonal(small dw)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_3PATCH_H, 0, 0, 100, 200, desc, expect, done);
    });
    ...
    it('test draw image tile 3patch horizonal(large dw)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_3PATCH_H, 0, 0, 300, 200, desc, expect, done);
    });
...
////
    it('test draw image tile 3patch vertical(small dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_3PATCH_V, 0, 0, 200, 100, desc, expect, done);
    });
    ...
    it('test draw image tile 3patch vertical(large dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_3PATCH_V, 0, 0, 200, 200, desc, expect, done);
    });
...
////
    it('test draw image tile 9patch(small dw && dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_9PATCH, 0, 0, 100, 100, desc, expect, done);
    });
    ...
    it('test draw image tile 9patch(large dw && dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_9PATCH, 0, 0, 200, 200, desc, expect, done);
    });
    ...
    it('test draw image tile 9patch(large dw)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_9PATCH, 0, 0, 200, 100, desc, expect, done);
    });
    ...
    it('test draw image tile 9patch(large dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_9PATCH, 0, 0, 100, 200, desc, expect, done);
    });
 //// 
    it('test draw image tile tileh(small dw)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE_H, 0, 0, 80, 200, desc, expect, done);
    });
    it('test draw image tile tileh(large dw)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE_H, 0, 0, 400, 200, desc, expect, done);
    });
 //// 
    it('test draw image tile tilev(small dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE_V, 0, 0, 200, 80, desc, expect, done);
    });
    it('test draw image tile tilev(large dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE_V, 0, 0, 200, 400, desc, expect, done);
    });
 //// 
    it('test draw image tile tile(small dw/dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE, 0, 0, 100, 100, desc, expect, done);
    });
    it('test draw image tile tile(large dw/dh)', (done) => {
        ...
        testDrawImage(qtk.ImageTile.DRAW_TILE, 0, 0, 400, 400, desc, expect, done);
    });
});
